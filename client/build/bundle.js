...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Contacts = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _XmlHttpHelper = __webpack_require__(161);
	
	var _XmlHttpHelper2 = _interopRequireDefault(_XmlHttpHelper);
	
	var _ApiToken = __webpack_require__(162);
	...
	var Contacts = function (_React$Component) {
	  ...
	  function Contacts() {
	    ...
	    var _this = _possibleConstructorReturn(this, (Contacts.__proto__ || Object.getPrototypeOf(Contacts)).call(this));
	
	    _this.state = { contacts: [] };
	    _this.populateState = _this.populateState.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(Contacts, [{
	    ...
	    value: function componentDidMount() {
	      var url = "https://api.sandbox.freeagent.com/v2/contacts";
	      _XmlHttpHelper2.default.getWithAuthorizationToken(url, _ApiToken2.default, this.populateState);
	    }
	  }, {
	    key: 'populateState',
	    value: function populateState(resultObject) {
	      this.setState({ contacts: resultObject.contacts });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var contactsComponents = this.state.contacts.map(function (contact) {
...
/***/ function(module, exports) {
	...
	var XmlHttpHelper = {
	  getWithAuthorizationToken: function getWithAuthorizationToken(url, token, onloadCallback) {
	  ...
	  postWithAuthorizationToken: function postWithAuthorizationToken(url, token, payload, onloadCallback) {
	    var req = new XMLHttpRequest();
	    req.open('POST', url);
	  ...
	  _setAuthorizationHeader: function _setAuthorizationHeader(req, token) {
...
/***/ function(module, exports) {
	...
	var ApiToken = "12fb-_8FFuMD4g41JRTPSMoAKy_ZxqWSANKIdJvNt";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Home = function (_React$Component) {
	  ...
	  function Home() {
	    ...
	    _this.state = { first_name: "Loading" };
	    _this.populateState = _this.populateState.bind(_this);
	    // this.user = user;
	    return _this;
	  }
	  ...
	  _createClass(Home, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      var url = "https://api.sandbox.freeagent.com/v2/users/me";
	      _XmlHttpHelper2.default.getWithAuthorizationToken(url, _ApiToken2.default, this.populateState);
	    }
	  }, {
	    key: 'populateState',
	    value: function populateState(_ref) {
	      var user = _ref.user;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Projects = function (_React$Component) {
	  ...
	  _createClass(Projects, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      var url = "https://api.sandbox.freeagent.com/v2/projects";
	      _XmlHttpHelper2.default.getWithAuthorizationToken(url, _ApiToken2.default, this.populateState);
	    }
	  }, {
	    key: 'populateState',
	    value: function populateState(projectsObject) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Contact = function Contact(_ref) {
	  ...
	  var templateString = first_name + ' ' + last_name;
